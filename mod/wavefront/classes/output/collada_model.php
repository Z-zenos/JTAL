 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class collada_model implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        // A collada model contains an XML file.
        // The textures are loaded automatically so we don't need to specify them.
        $modelerr = true;
        $daefile = null;
